...
public class ReverseIntakeCmd extends Command{
    ...
    public ReverseIntakeCmd(IntakeShooterSubsystem intakeShooterSubsystem, DeflectorSubsystem deflectorSubsystem){
    ...
    @Override
    public void execute() {
        intakeShooterSubsystem.reverseIntake();
        deflectorSubsystem.reverseIntakeDeflection();
